...
(cl:defmethod cl:initialize-instance :after ((m <DoDishesGoal>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DoDishesGoal)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name hrg_movebase-msg:<DoDishesGoal> is deprecated: use hrg_movebase-msg:DoDishesGoal instead.")))

(cl:ensure-generic-function 'dishwasher_id-val :lambda-list '(m))
(cl:defmethod dishwasher_id-val ((m <DoDishesGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hrg_movebase-msg:dishwasher_id-val is deprecated.  Use hrg_movebase-msg:dishwasher_id instead.")
  (dishwasher_id m))
