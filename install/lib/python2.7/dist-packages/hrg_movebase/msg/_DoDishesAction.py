...
"""autogenerated by genpy from hrg_movebase/DoDishesAction.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct

import hrg_movebase.msg
import genpy
...
class DoDishesAction(genpy.Message):
  ...
  _type = "hrg_movebase/DoDishesAction"
...
"""
  ...
  _slot_types = ['hrg_movebase/DoDishesActionGoal','hrg_movebase/DoDishesActionResult','hrg_movebase/DoDishesActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.action_goal is None:
        self.action_goal = hrg_movebase.msg.DoDishesActionGoal()
      if self.action_result is None:
        self.action_result = hrg_movebase.msg.DoDishesActionResult()
      if self.action_feedback is None:
        self.action_feedback = hrg_movebase.msg.DoDishesActionFeedback()
    else:
      self.action_goal = hrg_movebase.msg.DoDishesActionGoal()
      self.action_result = hrg_movebase.msg.DoDishesActionResult()
      self.action_feedback = hrg_movebase.msg.DoDishesActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_4I.pack(_x.action_goal.goal.dishwasher_id, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_4I.pack(_x.action_result.result.total_dishes_cleaned, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.dishwasher_id, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _struct_4I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (_x.action_result.result.total_dishes_cleaned, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs,) = _struct_4I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
