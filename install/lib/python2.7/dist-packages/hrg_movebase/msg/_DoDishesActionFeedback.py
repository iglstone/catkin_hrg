...
"""autogenerated by genpy from hrg_movebase/DoDishesActionFeedback.msg. Do not edit."""
import sys
...
class DoDishesActionFeedback(genpy.Message):
  ...
  _type = "hrg_movebase/DoDishesActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','hrg_movebase/DoDishesFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.feedback is None:
        self.feedback = hrg_movebase.msg.DoDishesFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = hrg_movebase.msg.DoDishesFeedback()
